...
+
	...
	; Bit 3 indicates level of bracelet required
...
@substate0:
	...
	; check if bracelet level is right
	ld e,Interaction.var36
	ld hl,wBraceletLevel
	ld a,(de)
	cp (hl)

	ld h,d
	ld l,Interaction.substate;e
	jr z,+
	; go to substate 4 because lever too heavy
	ld (hl),$04
	ld l,Interaction.counter1
	ld (hl),45
	ret
