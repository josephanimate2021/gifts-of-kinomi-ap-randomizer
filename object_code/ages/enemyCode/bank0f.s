...
@@substate0:
	...
	ld a,$02
	call _setVar30AndLoadAnimation
	jp objectSetVisible81
...
+
	...
	dec l ; Enemy.state
	ld (hl),$0b
	call _savePositionToVar33And34
	jr @animate
...
@@substate2:
	...
	ld a,(hl)
	inc a
	jp z,_func_54c6 ; jump if a was $ff
	ld e,Enemy.var38 ;$b8
	ld a,(de)
	ld b,a
	ld e,Enemy.angle ;$89
	...
	call @@func_5339
@func_5365:
	call _setPositionFromVar33And34
	call _ecom_bounceOffWallsAndHoles
	call objectApplySpeed
	call _savePositionToVar33And34
