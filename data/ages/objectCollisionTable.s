...
objectCollisionTable:
	...
	; ENEMYCOLLISION_IRON_MASK_DETACHED (0x05)
	...
	; ENEMYCOLLISION_MANHANDLA_BODY_VULNERABLE (0x32)
	...
	.db COLLISIONEFFECT_NONE;ELECTRIC_SHOCK	; ITEMCOLLISION_SWITCH_HOOK
	.db COLLISIONEFFECT_ELECTRIC_SHOCK;NONE			; ITEMCOLLISION_0e
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_0f

	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_10 (Rod of Seasons)
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_11
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_HARMLESS
	.db COLLISIONEFFECT_SWORD_NO_KNOCKBACK;2d;21				; ITEMCOLLISION_L2_BOOMERANG
	.db COLLISIONEFFECT_1c;NONE			; ITEMCOLLISION_AG_14
	.db COLLISIONEFFECT_1c;NONE			; ITEMCOLLISION_SOMARIA_BLOCK
	.db COLLISIONEFFECT_21;1c				; ITEMCOLLISION_THROWN_OBJECT
	.db COLLISIONEFFECT_NONE;1c				; ITEMCOLLISION_L1_BOOMERANG
	...
	.db COLLISIONEFFECT_DAMAGE_LINK		; ITEMCOLLISION_LINK
	.db COLLISIONEFFECT_05		; ITEMCOLLISION_L1_SHIELD	
	.db COLLISIONEFFECT_06		; ITEMCOLLISION_L2_SHIELD
	.db COLLISIONEFFECT_06		; ITEMCOLLISION_L3_SHIELD
	.db COLLISIONEFFECT_1b		; ITEMCOLLISION_L1_SWORD
	.db COLLISIONEFFECT_1b		; ITEMCOLLISION_L2_SWORD
	.db COLLISIONEFFECT_21		; ITEMCOLLISION_L3_SWORD
	.db COLLISIONEFFECT_1b		; ITEMCOLLISION_BIGGORON_SWORD
	.db COLLISIONEFFECT_1b		; ITEMCOLLISION_SWORDSPIN
	.db COLLISIONEFFECT_1b		; ITEMCOLLISION_SWORD_HELD
	.db COLLISIONEFFECT_1b		; ITEMCOLLISION_FIST_PUNCH
	.db COLLISIONEFFECT_21		; ITEMCOLLISION_EXPERT_PUNCH
	.db COLLISIONEFFECT_NONE	; ITEMCOLLISION_SHOVEL
	.db COLLISIONEFFECT_1c		; ITEMCOLLISION_SWITCH_HOOK
	.db COLLISIONEFFECT_1c		; ITEMCOLLISION_0e
	.db COLLISIONEFFECT_NONE	; ITEMCOLLISION_0f

	.db COLLISIONEFFECT_NONE	; ITEMCOLLISION_10 (Rod of Seasons)
	.db COLLISIONEFFECT_NONE	; ITEMCOLLISION_11
	.db COLLISIONEFFECT_NONE	; ITEMCOLLISION_HARMLESS
	.db COLLISIONEFFECT_20		; ITEMCOLLISION_L2_BOOMERANG
	.db COLLISIONEFFECT_21		; ITEMCOLLISION_AG_14
	.db COLLISIONEFFECT_2d		; ITEMCOLLISION_SOMARIA_BLOCK
	.db COLLISIONEFFECT_21		; ITEMCOLLISION_THROWN_OBJECT
	.db COLLISIONEFFECT_20		; ITEMCOLLISION_L1_BOOMERANG
	.db COLLISIONEFFECT_21		; ITEMCOLLISION_BOMB
	.db COLLISIONEFFECT_21		; ITEMCOLLISION_SWORD_BEAM
	.db COLLISIONEFFECT_20		; ITEMCOLLISION_MYSTERY_SEED
	.db COLLISIONEFFECT_21		; ITEMCOLLISION_EMBER_SEED
	.db COLLISIONEFFECT_21		; ITEMCOLLISION_SCENT_SEED
	.db COLLISIONEFFECT_20		; ITEMCOLLISION_PEGASUS_SEED
	.db COLLISIONEFFECT_20		; ITEMCOLLISION_GALE_SEED
	.db COLLISIONEFFECT_NONE	; ITEMCOLLISION_1f
/*
...
*/
	...
	; ENEMYCOLLISION_MANHANDLA_BODY_INVULNERABLE (0x4b)
	;.db $02 $06 $06 $05 $36 $36 $36 $36 $36 $36 $00 $36 $00 $00 $36 $00
	...
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_10 (SE $0c, Rod of Seasons)
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_11
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_HARMLESS
	.db COLLISIONEFFECT_2d;1c				; ITEMCOLLISION_L2_BOOMERANG (SE $16)
	.db COLLISIONEFFECT_1c;NONE			; ITEMCOLLISION_AG_14
	.db COLLISIONEFFECT_1c;NONE			; ITEMCOLLISION_SOMARIA_BLOCK (SE $13)
	.db COLLISIONEFFECT_1c				; ITEMCOLLISION_THROWN_OBJECT (SE $14)
	.db COLLISIONEFFECT_NONE;1c				; ITEMCOLLISION_L1_BOOMERANG (SE $15)
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_BOMB (SE $17)
	.db COLLISIONEFFECT_20;NONE			; ITEMCOLLISION_SWORD_BEAM
	.db COLLISIONEFFECT_20				; ITEMCOLLISION_MYSTERY_SEED
	.db COLLISIONEFFECT_20				; ITEMCOLLISION_EMBER_SEED
	.db COLLISIONEFFECT_20				; ITEMCOLLISION_SCENT_SEED
	.db COLLISIONEFFECT_20				; ITEMCOLLISION_PEGASUS_SEED
...
; removed as Veran will not be used and need space
	/*
...
; removed as Veran will not be used and need space
	...
	*/
	...
	; ENEMYCOLLISION_UNDEAD (0x7d)
	;; resolved issue with Manhandla by removing Veran data here ad at enemyCollisionModes.s
	.db $02 $10 $0f $0f $08 $09 $09 $0a $0a $08 $08 $0a $0d $2e $08 $25
	...
	; ENEMYCOLISION_MANHANDLA_HEAD_VULNERABLE (0x7e) 
	...
	.db COLLISIONEFFECT_06					; ITEMCOLLISION_L2_SHIELD
	.db COLLISIONEFFECT_06					; ITEMCOLLISION_L3_SHIELD
	.db COLLISIONEFFECT_1c					; ITEMCOLLISION_L1_SWORD
	.db COLLISIONEFFECT_1c					; ITEMCOLLISION_L2_SWORD
	.db COLLISIONEFFECT_1c					; ITEMCOLLISION_L3_SWORD
	.db COLLISIONEFFECT_1c					; ITEMCOLLISION_BIGGORON_SWORD
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_SWORDSPIN
	.db COLLISIONEFFECT_1c					; ITEMCOLLISION_SWORD_HELD
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_FIST_PUNCH
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_EXPERT_PUNCH
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_SHOVEL (SE $0d)
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_SWITCH_HOOK
	.db COLLISIONEFFECT_1c;NONE				; ITEMCOLLISION_0e
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_0f

	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_10 (SE $0c, Rod of Seasons)
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_11
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_HARMLESS
	.db COLLISIONEFFECT_SWORD_NO_KNOCKBACK;2d	; ITEMCOLLISION_L2_BOOMERANG (SE $16)
	.db COLLISIONEFFECT_1c;NONE				; ITEMCOLLISION_AG_14
	.db COLLISIONEFFECT_1c;NONE				; ITEMCOLLISION_SOMARIA_BLOCK (SE $13)
	.db COLLISIONEFFECT_SWORD_NO_KNOCKBACK;1c					; ITEMCOLLISION_THROWN_OBJECT (SE $14)
	.db COLLISIONEFFECT_SWORD_NO_KNOCKBACK;NONE					; ITEMCOLLISION_L1_BOOMERANG (SE $15)
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_BOMB (SE $17)
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_SWORD_BEAM
	.db COLLISIONEFFECT_20					; ITEMCOLLISION_MYSTERY_SEED
	.db COLLISIONEFFECT_20					; ITEMCOLLISION_EMBER_SEED
	.db COLLISIONEFFECT_20					; ITEMCOLLISION_SCENT_SEED
	.db COLLISIONEFFECT_20					; ITEMCOLLISION_PEGASUS_SEED
	...
	; ENEMYCOLLISION_MANHANDLA_CORE (0x7f)
	...
	.db COLLISIONEFFECT_06			; ITEMCOLLISION_L2_SHIELD
	.db COLLISIONEFFECT_06			; ITEMCOLLISION_L3_SHIELD
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_L1_SWORD
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_L2_SWORD
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_L3_SWORD
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_BIGGORON_SWORD
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_SWORDSPIN
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_SWORD_HELD
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_FIST_PUNCH
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_EXPERT_PUNCH
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_SHOVEL (SE $0d)
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_SWITCH_HOOK
	...
	.db COLLISIONEFFECT_NONE		; ITEMCOLLISION_HARMLESS
	.db COLLISIONEFFECT_2d;1c			; ITEMCOLLISION_L2_BOOMERANG (SE $16)
	.db COLLISIONEFFECT_21;NONE		; ITEMCOLLISION_AG_14
	.db COLLISIONEFFECT_1c;NONE		; ITEMCOLLISION_SOMARIA_BLOCK (SE $13)
	.db COLLISIONEFFECT_1c;21			; ITEMCOLLISION_THROWN_OBJECT (SE $14)
	.db COLLISIONEFFECT_21;1c			; ITEMCOLLISION_L1_BOOMERANG (SE $15)
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_BOMB (SE $17)
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_SWORD_BEAM
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_MYSTERY_SEED
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_EMBER_SEED
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_SCENT_SEED
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_PEGASUS_SEED
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_GALE_SEED
	.db COLLISIONEFFECT_NONE		; ITEMCOLLISION_1f
