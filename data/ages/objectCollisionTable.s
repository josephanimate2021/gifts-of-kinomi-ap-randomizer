...
objectCollisionTable:
	...
	.db COLLISIONEFFECT_ELECTRIC_SHOCK	; ITEMCOLLISION_SWITCH_HOOK
	...
	.db COLLISIONEFFECT_21				; ITEMCOLLISION_L2_BOOMERANG
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_AG_14
...
*/
	...
	; ENEMYCOLLISION_MANHANDLA_1 (0x4b)
	...
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_11
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_HARMLESS
	.db COLLISIONEFFECT_1c				; ITEMCOLLISION_L2_BOOMERANG (SE $16)
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_AG_14
	.db COLLISIONEFFECT_NONE			; ITEMCOLLISION_SOMARIA_BLOCK (SE $13)
	.db COLLISIONEFFECT_1c				; ITEMCOLLISION_THROWN_OBJECT (SE $14)
	.db COLLISIONEFFECT_1c				; ITEMCOLLISION_L1_BOOMERANG (SE $15)
...
*/
	...
	; ENEMYCOLLISION_MANHANDLA_HEAD (0x7d)
	...
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_11
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_HARMLESS
	.db COLLISIONEFFECT_SWORD_NO_KNOCKBACK	; ITEMCOLLISION_L2_BOOMERANG (SE $16)
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_AG_14
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_SOMARIA_BLOCK (SE $13)
	.db COLLISIONEFFECT_1c					; ITEMCOLLISION_THROWN_OBJECT (SE $14)
	.db COLLISIONEFFECT_SWORD_NO_KNOCKBACK;1c					; ITEMCOLLISION_L1_BOOMERANG (SE $15)
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_BOMB (SE $17)
	.db COLLISIONEFFECT_NONE				; ITEMCOLLISION_SWORD_BEAM
	.db COLLISIONEFFECT_20					; ITEMCOLLISION_MYSTERY_SEED
	.db COLLISIONEFFECT_20					; ITEMCOLLISION_EMBER_SEED
	...
	; ENEMYCOLLISION_MANHANDLA_3 (0x7e)
	...
	.db COLLISIONEFFECT_NONE		; ITEMCOLLISION_AG_14
	.db COLLISIONEFFECT_NONE		; ITEMCOLLISION_SOMARIA_BLOCK (SE $13)
	.db COLLISIONEFFECT_21			; ITEMCOLLISION_THROWN_OBJECT (SE $14)
	.db COLLISIONEFFECT_1c			; ITEMCOLLISION_L1_BOOMERANG (SE $15)
	...
	;; TODO: This crossitems addition conflicts with manhandla!
	;; .db $02 $10 $0f $0f $08 $09 $09 $0a $0a $08 $08 $0a $0d $2e $08 $25
