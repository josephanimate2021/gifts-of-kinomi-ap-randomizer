...
m_PaletteHeaderStart $5a, PALH_5a
	m_PaletteHeaderBg  2, 6, paletteDataSummer
	m_PaletteHeaderEnd

m_PaletteHeaderStart $5b, PALH_5b
	m_PaletteHeaderBg  2, 6, paletteDataAutumn
	m_PaletteHeaderEnd

m_PaletteHeaderStart $5c, PALH_5c
	m_PaletteHeaderBg  2, 6, paletteDataWinter
	m_PaletteHeaderEnd

m_PaletteHeaderStart $5d, PALH_5d
	m_PaletteHeaderBg  2, 6, paletteDataSpring
	m_PaletteHeaderEnd
...
m_PaletteHeaderStart $68, PALH_68
	m_PaletteHeaderBg  2, 6, paletteDataWoodsSummer
	m_PaletteHeaderEnd

m_PaletteHeaderStart $69, PALH_69
	m_PaletteHeaderBg  2, 6, paletteDataWoodsAutumn
	m_PaletteHeaderEnd

m_PaletteHeaderStart $6a, PALH_6a
	m_PaletteHeaderBg  2, 6, paletteDataWoodsWinter
	m_PaletteHeaderEnd

m_PaletteHeaderStart $6b, PALH_6b
	m_PaletteHeaderBg  2, 6, paletteDataWoodsSpring
	m_PaletteHeaderEnd

m_PaletteHeaderStart $6c, PALH_6c
	m_PaletteHeaderBg  2, 6, paletteDataTemple
	m_PaletteHeaderEnd
...
m_PaletteHeaderStart $cb, PALH_cb
	m_PaletteHeaderSpr 6, 1, paletteDataManhandla
	m_PaletteHeaderEnd