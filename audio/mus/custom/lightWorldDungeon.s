...
; Measure 1
	...
	env $0 $00
	vol HI_VOL
	goto lightWorldDungeonChannel1Measure1
; Measure 2a
	goto lightWorldDungeonChannel1Measure2a
...
;	9/8
	transpose 0
	vol HI_VOL
	goto lightWorldDungeonChannel1Measure9
	octave 3
;	beat b E2+Q+W+W	
	beat b E2+HF
	vol LO_VOL
...
lightWorldDungeonChannel1Measure20aLoop:
; Measure 20a-21
	vol HI_VOL
	duty $02
	env $0 $00
	vibrato $00
	octave 4
	goto lightWorldDungeonChannel1Measure20a
; Measure 22a-23
	transpose c4-cs4
	goto lightWorldDungeonChannel1Measure20a
; Measure 24a-25
...
; Measure 42-43
	...
	goto lightWorldDungeonChannel1Measure20aLoop
	cmdff
...
lightWorldDungeonChannel1Measure2a:
; Measure 2a
	env $0 $00
	beat c E2+HF
	vol LO_VOL
...
lightWorldDungeonChannel1Measure9:
; Measure 9
	octave 4
...
lightWorldDungeonChannel1Measure20a:
; Measure 20a-21
beginLoop 2
	beat cs E2 d E1 a E2+E1
breakOrLoop
	beat cs E2 d E1 a E2+Q+E1 r E2+E1
	endSec	
...
; Measure 1
	...
	beat gs W+HF r W+E2 ;skipping S1 for 7/8
; Measure 5-6
	vol LO_VOL
	env $2 $00
	goto lightWorldDungeonChannel1Measure1
; Measure 6b
	goto lightWorldDungeonChannel0Measure6b
	beat r Q
; Measure 9-10
	vol LO_VOL
	goto lightWorldDungeonChannel1Measure9
...
lightWorldDungeonChannel0Measure20aLoop:
; Measure 20a-21
	transpose 0
	vol HI_VOL
	duty $02
	env $1 $00
	vibrato $00
	goto lightWorldDungeonChannel0Measure20a
; Measure 22a-23
	transpose c4-cs4
	goto lightWorldDungeonChannel0Measure20a
; Measure 24a-25
...
; Measure 42a-43
	...
	goto lightWorldDungeonChannel0Measure20aLoop
	cmdff
...
lightWorldDungeonChannel0Measure20a:
; Measure 20a-21
	octave 4
beginLoop 2
	beat cs E2 d E1 a E2+E1
breakOrLoop
	beat cs E2 d E1 r E2+Q+E1-ECHO_WAIT a ECHO_WAIT r E2+E1
	endSec	
...
lightWorldDungeonChannel4Measure20Loop:
; Measure 20-21
	transpose 0
	goto lightWorldDungeonChannel4Measure18
; Measure 22-23
...
; Measure 42-43
	...
	goto lightWorldDungeonChannel4Measure20Loop
	cmdff

lightWorldDungeonChannel4Measure18:
; Measure 18-19
	octave 2
beginLoop 8 ; 2 beats for measures 
	duty HI_VOL
	beat b S1
	duty LO_VOL
	beat b T3 r T4
...
/*
	...
	vol $4
	beat $2a Q $2a Q $2a Q
	goto lightWorldDungeonChannel6
*/
